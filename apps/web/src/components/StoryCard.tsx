...
export function StoryCard({ story, onClick }: { story: Story; onClick: () => void }) {
    return (
        <Card
            onClick={onClick}
            className="group relative overflow-hidden cursor-pointer transition-all hover:scale-[1.02] hover:shadow-primary/20 hover:shadow-xl border-none aspect-[3/4] rounded-2xl"
        >
            <img
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#1A1265] via-[#1A1265]/80 to-transparent opacity-90 transition-opacity group-hover:opacity-100" />
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-5">
                <div className="flex flex-wrap gap-2 mb-3">
                    ...
                    <Badge variant="outline" className="text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 border-primary text-primary backdrop-blur-sm">
                ...
                <div className="flex items-center justify-between mt-2">
                    <p className="text-sm font-bold text-primary line-clamp-1">Por {story.author}</p>
