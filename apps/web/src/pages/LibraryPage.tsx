    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 ease-out">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-foreground drop-shadow-sm">Biblioteca</h1>
                    <p className="text-muted-foreground mt-1 text-sm font-medium">Explore contos mágicos para ninar.</p>
                </div>
            ...
            {stories.length === 0 ? (
                <div className="py-20 text-center flex flex-col items-center">
                    ...
                    <p className="text-muted-foreground mt-1 text-sm">Vá para o painel Admin e use o botão "Seed" para gerar histórias de exemplo.</p>
                </div>
            ) : (
